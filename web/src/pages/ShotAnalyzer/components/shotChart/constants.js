...
export const CHART_COLOR_FALLBACKS = {
  ...
  flow: '#63993D',
  puckFlow: '#059669',
  puckResistance: '#8B5E3C',
  liquidResistance: '#B06E3C',
  weight: '#8B5CF6',
  weightFlow: '#6d28d9',
...
export const CHART_COLOR_TOKEN_MAP = {
  ...
  puckResistance: '--analyzer-puckresistance-anchor',
  liquidResistance: '--analyzer-liquidresistance-anchor',
...
export const TOOLTIP_GROUP_BY_LABEL = {
  ...
  'Target F': 'flow',
  'Puck Flow': 'flow',
  'Puck Resistance': 'resistance',
  'Liquid Resistance': 'resistance',
  Weight: 'weight',
  'Weight Flow': 'weight',
...
export const UNIT_BY_LABEL = {
  ...
  'Target F': 'ml/s',
  'Puck Flow': 'ml/s',
  'Puck Resistance': 's·√bar/mL',
  'Liquid Resistance': 'bar·s/mL',
  Weight: 'g',
  'Weight Flow': 'g/s',
